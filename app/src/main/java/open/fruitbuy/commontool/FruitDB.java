package open.fruitbuy.commontool;
...
public class FruitDB {
    ...
    public FruitPreferenceBean queryTypePerference(int typeid) {
        for(FruitPreferenceBean each:queryPerference()){
    ...
    public boolean insertPerference(int typeid, int currentnum, int minnum, int maxnum,
                                    float minprice, float maxprice, int salerid, int autoorder) {
        ...
        try {
            ...
            contentValues.put("currentnum", currentnum);
    ...
    public boolean insertStorage(int fsid, int typeid, int salerid, int orderid, String date) {
        ...
        try {
            ...
            contentValues.put("typeid", typeid);
            contentValues.put("saleid", salerid);
    ...
    public List<FruitPreferenceBean> queryPerference() {
        ...
        while (cursor.moveToNext()) {
            FruitPreferenceBean bean = new FruitPreferenceBean(cursor.getInt(0), cursor.getInt(1),
                    cursor.getInt(2), cursor.getInt(3), cursor.getFloat(4), cursor.getFloat(5),
    ...
    public void updatePreferenceCurrentNumByOne(int typeId, int amount) {
        FruitPreferenceBean bean =  queryTypePerference(typeId);
        deletePerference(typeId);
        insertPerference(typeId, bean.getCurrentnum()+amount, bean.getMinnum(), bean.getMaxnum(), bean.getMinprice(), bean.getMaxprice(), bean.getSalerid(), bean.getAutoorder());
    }
}
